...
import net.cserny.core.move.automove.AutoMoveMedia;
import net.cserny.core.move.automove.AutoMoveMediaRepository;
import net.cserny.core.move.automove.AutoMoveMediaService;
