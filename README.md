...
NOTE: Host media folders need to be mounted at /work/media/ downloads or movies or tv
...
You can then execute your native executable with: `./target/plexhelp-commander-1.0.0-runner`
